...
import { search } from 'Frontend/generated/CancionService';
...
function CancionEntryForm(props: CancionEntryFormProps) {
  ...
  useEffect(() => {
    CancionService.listaGeneroCombo().then(data =>
      //console.log(data)
...
export default function CancionView() {
  ...
  const order = (event, columnId) => {
    ...
    if (!direction) {
      ...
      CancionService.order(columnId, dir).then(setItems);
    }
  }
